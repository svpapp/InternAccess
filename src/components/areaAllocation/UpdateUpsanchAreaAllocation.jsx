...
// import {
//   useGetUpsanchAreaAllocationById,
//   useUpdateUpsanchAreaAllocation,
// } from '../../hooks/newAreaAllocation/upsanchArea/useUpsanchArea';
...
// import {useGetNewSanchAreaAllocation} from '../../hooks/newAreaAllocation/sanchArea/useSanchArea';
// import {UpsanchAreaAllocationSchema} from '../../utils/ValidationSchema';
...
// const UpdateUpanchAreaAllocation = ({navigation, route}) => {
//   const {upSanchNameId} = route.params;
//   const formikRef = useRef();

//   const {updateUpsanchArea, loading} = useUpdateUpsanchAreaAllocation();
//   const {zones, loading: zoneLoading, error: zoneError} = useZoneData();
//   const {getUpsanchAreaById} = useGetUpsanchAreaAllocationById();
//   const {
//     data: anchalData,
//     error: anchalError,
...
//     data: sanchData,
//     error: sanchError,
//     loading: sanchLoading,
//   } = useGetNewSanchAreaAllocation();
...
//       sanch: () =>
//         sanchData?.map(sanch => ({
//           label: sanch.sanchName,
//           value: sanch.sanchName,
//           sanchAreaId: sanch.sanchNameId,
//           zoneName: sanch.zoneName,
//           states: sanch.states,
//         })) || [],
...
//       }),
//       sanch: () => ({
//         selectedSanch: getFilteredOptions(values, 'sanch').find(
//           z => z.value === selectedValues,
//         ),
//         selectedZone: null,
//         selectedStates: [],
...
//       if (!upSanchNameId || !zones?.length || !anchalData?.length) return;

//       try {
//         const data = await getUpsanchAreaById(upSanchNameId);
//         if (!data) return;

//         const formattedData = {
//           upSanchName: data.upSanchName,
...
//           },
//           selectedSanch: {
//             label: data.sanchName,
//             value: data.sanchName,
//             sanchAreaId: data.sanchNameId,
//             zoneName: data.zoneName,
//             states: data.states,
//           },
//           selectedZone: {
...
//         Alert.alert('Error', 'Failed to fetch Upsanch area details');
//       }
//     };

//     fetchSankulArea();
//   }, [upSanchNameId, zones, anchalData]);
...
//         sanchName: values.selectedSanch.sanchAreaId,
//         upSanchName: values.upSanchName,
...
//       const response = await updateUpsanchArea(upSanchNameId, formattedData);

//       if (response.result) {
//         Alert.alert('Success', 'Upsanch Area Allocation Updated Successfully!');
//         navigation.navigate('GetUpsanchAreaAllocation');
//       }
//     } catch (error) {
//       Alert.alert(
//         'Error',
//         error.message || 'Failed to Update Upanch Area Allocation',
//       );
//     } finally {
//       setSubmitting(false);
//     }
...
//       <Text style={styles.headerText}>Update Upsanch Area Allocation</Text>

//       <Formik
//         innerRef={formikRef}
//         initialValues={initialValues}
//         validationSchema={UpsanchAreaAllocationSchema}
//         onSubmit={handleUpdateArea}
//         enableReinitialize>
//         {({values, setFieldValue, isValid, handleSubmit, errors, touched}) => (
//           <View style={styles.formContainer}>
//             <FormField name="upSanchName" label="Upsanch Name">
//               <Input
//                 placeholder="Enter Upsanch Name"
//                 value={values.sanch}
//                 onChangeText={text => setFieldValue('upSanchName', text)}
//                 error={touched.upSanchName && errors.upSanchName}
//               />
//             </FormField>
...
//                 name: 'sanch',
//                 label: 'Sanch',
//                 items: getFilteredOptions(values, 'sanch'),
//                 value: values.selectedSanch?.value,
//                 zIndex: 6000,
//               },
//               {
//                 name: 'zone',
...
// export default UpdateUpanchAreaAllocation;
